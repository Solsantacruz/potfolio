...
const About = () => {
    return(
      ...
      <h2 className="text-3xl font-extrabold text-fondo ml-[110px] md:ml-[450px]">Sobre Mi</h2>
        ...
        <div class="text-center md:text-center md:mt-8 lg:mt-10 lg:ml-20 md:w-2/3 lg:w-full">
          ...
          <div class="text-center md:text-left md:mt-12 lg:mt-5 md:ml-12 lg:ml-10 ">
            <p class="text-fondo  fontPoppins md:text-lg mx-2 mt-2 italic pb-5">
